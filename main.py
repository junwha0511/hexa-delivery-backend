...
def top_list():    
    ...
    # order 3개 select
    cursor.execute("SELECT oid, name, exp_time FROM order_info INNER JOIN restaurant WHERE Datetime(exp_time)>'{}' ORDER BY exp_time LIMIT 3".format(datetime.now().isoformat()))
